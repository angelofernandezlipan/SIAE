...
public class UtilidadesJSON {
    ...
    // Método para leer datos de un archivo JSON y devolver un objeto JsonObject
    ...
    // Método para escribir un JsonObject en un archivo JSON
    ...
    // Método genérico para convertir un JsonArray a una lista de objetos
    ...
    // Método genérico para convertir una lista de objetos a un JsonArray
